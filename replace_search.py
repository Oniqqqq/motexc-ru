...
pattern = re.compile(r'<div class="header_search serach_selected_head(?: yumal-header-search-patch)?">.*?</script>\s*</div>', re.DOTALL)
...
for file in html_files:
    ...
    # use lambda to avoid interpreting replacement string as backrefs
