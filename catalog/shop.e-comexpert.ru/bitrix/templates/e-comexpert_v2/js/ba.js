    ...
    function _ba_punycode() {
        ...
        function o(e) {
            ...
            for (r = 0 < h ? h + 1 : 0; r < u;) {
                ...
                if (f = function(e, t, n) {
                    var r = 0;
                    for (e = n ? R(e / S) : e >> 1, e += R(e / t); A * v >> 1 < e; r += p) e = R(e / A);
        ...
        var c = 2,
            n = ("https:" == document.location.protocol ? "https://" : "http://") + "bitrix.info/bx_stat",
            d = {
                host: null,
                aid: null
            },
            u = function(e) {
                if (!i._ba) return "";
                for (var t = "", n = 0; n < i._ba.length; n++) {
                    var r = i._ba[n];
            ...
            m = {
                ...
                encode: function(e) {
                    var t, n, r, o, a, i, c = "",
                        d = 0;
                    for (e = m._utf8_encode(e); d < e.length;) r = (i = e.charCodeAt(d++)) >> 2, o = (3 & i) << 4 | (t = e.charCodeAt(d++)) >> 4, a = (15 & t) << 2 | (n = e.charCodeAt(d++)) >> 6, i = 63 & n, isNaN(t) ? a = i = 64 : isNaN(n) && (i = 64), c = c + this._keyStr.charAt(r) + this._keyStr.charAt(o) + this._keyStr.charAt(a) + this._keyStr.charAt(i);
                    return c
                },
                decode: function(e) {
                    var t, n, r, o, a, i = "",
                        c = 0;
                    for (e = e.replace(/[^A-Za-z0-9+/=]/g, ""); c < e.length;) t = this._keyStr.indexOf(e.charAt(c++)) << 2 | (r = this._keyStr.indexOf(e.charAt(c++))) >> 4, n = (15 & r) << 4 | (o = this._keyStr.indexOf(e.charAt(c++))) >> 2, r = (3 & o) << 6 | (a = this._keyStr.indexOf(e.charAt(c++))), i += String.fromCharCode(t), 64 != o && (i += String.fromCharCode(n)), 64 != a && (i += String.fromCharCode(r));
        ...
        i._baq = i._baq || {}, i._baq.setResponse = function(e) {
            var t;
            null == function(e) {
                e = document.cookie.match(new RegExp("(?:^|; )" + e.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g, "\\$1") + "=([^;]*)"));
                return e ? decodeURIComponent(e[1]) : void 0
            }("BX_USER_ID") && e.uid && (t = new Date((new Date).getTime() + 31536e7), document.cookie = "BX_USER_ID=" + e.uid + "; path=/; expires=" + t.toUTCString())
        };
        ...
        function l(e) {
            if (!e) return {};
            var t = e.navigationStart || e.startTime,
                n = "";
            if (e.serverTiming && 0 < e.serverTiming.length)
                for (var r = 0; r < e.serverTiming.length; r++) {
                    var o = e.serverTiming[r];
                    "string" == typeof o.name && o.name.length && (n += ("" === n ? "" : ",") + o.name + ":" + o.duration)
                }
            return {
                domContentLoaded: Math.ceil(e.domContentLoadedEventStart - t),
                connectionTime: Math.ceil(e.connectEnd - e.connectStart),
                domainLookup: Math.ceil(e.domainLookupEnd - e.domainLookupStart),
                serverRequestTime: Math.ceil(e.responseStart - e.requestStart),
                downloadTime: Math.ceil(e.responseEnd - e.responseStart),
                domInteractive: Math.ceil(e.domInteractive - t),
                redirectTime: Math.ceil(e.fetchStart - t),
                serverTiming: n
            }
        }
        ...
        function p() {
            ...
            var r = 0,
                o = i.performance.timing;
            o && (r = o.domInteractive - o.domLoading);
            var a = null !== i.location.search.match("IFRAME=Y"),
                t = l(s),
                o = "d=" + encodeURIComponent(i.location.host) + "&ru=" + encodeURIComponent(i.location.pathname) + "&dns=" + t.domainLookup + "&tcp=" + t.connectionTime + "&srt=" + t.serverRequestTime + "&pdt=" + t.downloadTime + "&rrt=" + t.redirectTime + "&dit=" + t.domInteractive + "&clt=" + t.domContentLoaded + "&st=" + t.serverTiming + "&prc=" + r + "&sr=" + i.screen.width + "x" + i.screen.height + "&com=" + (f ? "1" : "0") + "&slr=" + (a ? "1" : "0") + "&tmz=" + (new Date).getTimezoneOffset() + "&xts=" + (new Date).getTime() + "&ver=" + c + "&aid=" + encodeURIComponent(d.aid),
                r = i.BX && i.BX.frameCache ? i.BX.frameCache : null;
...
if (document.cookie.split(';').some((item) => item.trim().startsWith('BX_USER_ID='))) {

} else{
    BX.setCookie('BX_USER_ID', generateRandomString(20), {expires: 86400*14});
}
